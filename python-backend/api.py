...
def _get_agent_by_name(name: str):
    ...
    agents = {
        ...
        document_parser_agent.name: document_parser_agent,
        journal_entry_agent.name: journal_entry_agent,
        quickbooks_lookup_agent.name: quickbooks_lookup_agent,
    }
...
def _build_agents_list() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        make_agent_dict(document_parser_agent),
        make_agent_dict(journal_entry_agent),
        make_agent_dict(quickbooks_lookup_agent),
    ]
...
async def chat_endpoint(req: ChatRequest):
    ...
    try:
        ...
        refusal = "Sorry, I can only answer questions related to accounting tasks."
